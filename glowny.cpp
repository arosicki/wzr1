...
void PoczatekInterakcji()
{
	...
	multi_reciv = new multicast_net("224.12.12.75", 10001);      // obiekt do odbioru ramek sieciowych
	multi_send = new multicast_net("224.12.12.75", 10001);       // obiekt do wysy³ania ramek
